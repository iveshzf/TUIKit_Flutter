  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (context, giftDataMap, child) {
        ...
        _giftBullets.add(GiftBulletAnimationWidget(key: UniqueKey(), giftData: giftData!));
        TUIGiftStore().giftDataMap.value[roomId] = null;
...
class GiftBulletAnimationWidgetState extends State<GiftBulletAnimationWidget> with TickerProviderStateMixin {
        ...
        child: Transform.translate(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.all(Radius.circular(context.adapter.getWidth(20)))),
              child: Stack(
                children: [
                  Positioned(
                    left: context.adapter.getWidth(4),
                    top: context.adapter.getWidth(4),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        _buildUserName(context, widget.giftData.sender),
                                        style: const TextStyle(
                                            fontSize: 14, overflow: TextOverflow.ellipsis, color: GiftColors.designG8),
                                      ),
                                      LayoutBuilder(builder: (context, constraints) {
                                        return Text(
                                          widget.giftData.gift.name,
                                          overflow: TextOverflow.ellipsis,
                                          style: const TextStyle(fontSize: 10, color: GiftColors.grayColor),
                                          maxLines: 1,
                                          softWrap: false,
                  ...
                  Positioned(
                    ...
                    height: context.adapter.getWidth(40),
                    child: CachedNetworkImage(
                      imageUrl: widget.giftData.gift.iconURL,
                      fit: BoxFit.fitWidth,
  ...
  String _buildUserName(BuildContext context, LiveUserInfo user) {
