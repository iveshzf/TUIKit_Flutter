...
- Android & iOS:
  Architecture upgraded: replaced the gift logic with the new GiftStore from AtomicXCore.
  Compatible with Tencent Effect Player, supporting the playback of gift assets with sound effects.
...
- Android & iOS: Fixed the issue where the default gift resources in an English environment were
  still in Chinese
