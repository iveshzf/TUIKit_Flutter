...
class BarrageItemWidget extends StatelessWidget {
  const BarrageItemWidget({super.key, required this.barrage});
  ...
  Widget _buildBarrageContentWidget(BuildContext context) {
    String anchorSpaceHolder = barrage.sender.userID == Store().ownerId
    ...
    return Flexible(
      child: Stack(
        children: [
          ...
          Visibility(
              visible: barrage.sender.userID == Store().ownerId,
              child: Container(
                width: 42,
                height: 14,
                decoration: BoxDecoration(
