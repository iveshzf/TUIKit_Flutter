...
abstract class LiveKitLocalizations {
  ...
  /// No description provided for @common_request_rejected.
  ///
  /// In en, this message translates to:
  /// **'xxx rejected'**
  String get common_request_rejected;
  ...
  /// No description provided for @common_voiceroom_invite_seat_rejected.
  ///
  /// In en, this message translates to:
  /// **'Seat invitation has been rejected'**
  String get common_voiceroom_invite_seat_rejected;

  /// No description provided for @common_voiceroom_invite_seat_timeout.
  ///
  /// In en, this message translates to:
  /// **'Seat invitation timeout'**
  String get common_voiceroom_invite_seat_timeout;
  ...
  /// No description provided for @common_host_kick_user_after_connect.
  ///
  /// In en, this message translates to:
  /// **'The connection is successful. Users beyond the first 6 seats have been removed.'**
  String get common_host_kick_user_after_connect;

  /// No description provided for @common_audience_kicked_re_apply.
  ///
  /// In en, this message translates to:
