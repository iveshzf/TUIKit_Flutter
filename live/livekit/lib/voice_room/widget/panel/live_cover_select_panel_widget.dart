...
class LiveCoverSelectPanelWidget extends StatefulWidget {
  ...
  const LiveCoverSelectPanelWidget(
      {super.key, required this.prepareStore, required this.coverUrls, required this.initialCoverUrl});

  @override
  State<LiveCoverSelectPanelWidget> createState() => _LiveCoverSelectPanelWidgetState();
}

class _LiveCoverSelectPanelWidgetState extends State<LiveCoverSelectPanelWidget> {
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                LiveKitLocalizations.of(Global.appContext())!.common_set_as_cover,
