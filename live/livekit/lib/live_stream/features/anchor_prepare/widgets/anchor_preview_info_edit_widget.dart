...
class AnchorPreviewInfoEditWidget extends StatefulWidget {
  ...
  const AnchorPreviewInfoEditWidget({super.key, required this.editInfo, required this.liveStreamManager});

  @override
  State<AnchorPreviewInfoEditWidget> createState() => _AnchorPreviewInfoEditWidgetState();
}
                      ...
                      return SizedBox(
                        ...
                        child: TextField(
                            ...
                            style: const TextStyle(
                                fontSize: 16, color: LiveColors.designStandardG8, fontWeight: FontWeight.w500),
                            onChanged: (value) {
