...
class AnchorCoGuestFloatWidget extends StatefulWidget {
  ...
  const AnchorCoGuestFloatWidget({super.key, required this.liveStreamManager});

  @override
  State<AnchorCoGuestFloatWidget> createState() => _AnchorCoGuestFloatWidgetState();
}
...
class _AnchorCoGuestFloatWidgetState extends State<AnchorCoGuestFloatWidget> {
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: LiveColors.notStandardWhite20Transparency, width: 1.radius),
      ...
      child: Stack(
        children: [
          Positioned(
            right: 0,
            child: Visibility(
              visible: _getCoGuestState().applicants.value.length > 2,
              child: Container(
                width: 36.width,
                height: 36.width,
                decoration: BoxDecoration(
          ...
          Positioned(
            ...
            child: Visibility(
              ...
              child: Container(
                ...
                child: ClipOval(
                  child: Image.network(
                    _getCoGuestState().applicants.value.isNotEmpty
                        ? _getCoGuestState().applicants.value.toList()[0].avatarURL
                        : '',
                    fit: BoxFit.cover,
          ...
          Positioned(
            right: 36,
            child: Visibility(
              visible: _getCoGuestState().applicants.value.length > 1,
              child: Container(
                width: 36.radius,
                height: 36.radius,
                decoration: BoxDecoration(
  ...
  Widget _buildApplicantCountWidget() {
    return Container(
      ...
      child: Text(
        '${LiveKitLocalizations.of(Global.appContext())!.common_apply_link_mic}(${_getCoGuestState().applicants.value.length})',
...
extension on _AnchorCoGuestFloatWidgetState {
  ...
  CoGuestState _getCoGuestState() {
    final liveID = liveStreamManager.roomState.roomId;
