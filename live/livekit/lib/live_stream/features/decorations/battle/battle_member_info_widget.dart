...
class _BattleMemberInfoWidgetState extends State<BattleMemberInfoWidget> {
        ...
        Positioned(
            ...
            child: ListenableBuilder(
                listenable: Listenable.merge([
                  widget.liveStreamManager.battleState.battleUsers,
                ...
                builder: (context, _) {
                  ...
                  final isMultiplePeopleMode = coHostStore.coHostState.connected.value.length >= 3;
  ...
  Widget _buildScoreWidget() {
    final battleUser = widget.liveStreamManager.battleState.battleUsers.value
        .where((user) => user.userId == widget.battleUserId)
        .firstOrNull;
    if (battleUser == null) return const SizedBox.shrink();
    return Container(
      height: 28.height,
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Image.asset(getRankingImageNamesByUser(battleUser), package: Constants.pluginName),
  ...
  String getRankingImageNamesByUser(BattleUser battleUser) {
