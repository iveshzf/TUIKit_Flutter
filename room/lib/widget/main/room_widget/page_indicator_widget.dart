...
class PageIndicatorWidget extends StatelessWidget {
  ...
  const PageIndicatorWidget({
    ...
    this.color = RoomColors.g3,
    this.activeColor = RoomColors.white,
  ...
  Widget build(BuildContext context) {
    return Align(
      alignment: align == IndicatorAlign.top ? Alignment.topCenter : Alignment.bottomCenter,
          ...
          children: List.generate(pageCount, (index) {
            return Container(
              ...
              decoration: BoxDecoration(
                shape: shape == IndicatorShape.circle ? BoxShape.circle : BoxShape.rectangle,
                borderRadius: shape == IndicatorShape.roundedRectangle ? BorderRadius.circular(4) : null,
