...
import 'package:tencent_calls_uikit_example/src/profile_widget.dart';
import 'package:tencent_calls_uikit_example/src/settings/settings_config.dart';
import 'package:tencent_cloud_chat_sdk/tencent_im_sdk_plugin.dart';
import 'package:url_launcher/url_launcher.dart';

import 'package:tencent_calls_uikit_example/debug/generate_test_user_sig.dart';
import 'package:tencent_calls_uikit_example/generate/app_localizations.dart';
import 'package:tencent_calls_uikit_example/src/main_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: Stack(
          children: [_getAppInfoWidget(), _getLoginWidget(), _getQuickAccessWidget()],
        ),
      ),
    );
  }
